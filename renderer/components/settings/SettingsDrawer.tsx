		...
		<>
			...
			>
				...
				<div className="settings-drawer__body">
					...
					/>
					<ToggleSwitch
						id="toggle-deep-clean-pdf"
						checked={settings.deepCleanPdf}
						onChange={(v) => handleToggle("deepCleanPdf", v)}
						label="Deep-clean PDFs"
						description="Rewrite PDFs so hidden metadata is physically removed (needs qpdf)"
					/>
					<ToggleSwitch
						id="toggle-maximum-scrub"
						checked={settings.maximumScrub}
						onChange={(v) => handleToggle("maximumScrub", v)}
						label="Maximum scrub"
						description="Also strip orientation and color profile — most thorough, may rotate or shift colors"
					/>
					{isMac && (
						<ToggleSwitch
